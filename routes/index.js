...
router.get("/", controller.allFoods);

router.post("/signup", controller.newUser);

router.post("/login", controller.login);

router.put("/edit", auth.decodeToken, controller.userUpdate);

router.put("/updatepassword", auth.decodeToken, controller.updatePassword);

router.post("/requestpasswordreset", controller.requestPasswordReset);

router.post("/resetpassword", controller.resetPassword);
router.get("/:id", auth.decodeToken, controller.userProfile);
